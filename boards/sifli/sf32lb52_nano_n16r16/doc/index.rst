.. zephyr:board:: sf32lb52_core_n16r16

Overview
********

SF32LB52-Core-N16R16 is a compact development board based on the SF32LB52x
series SoC. It is mainly used for developing and evaluating applications
based on the SF32LB52x series chip.

More information about the board can be found at the
`SF32LB52-Core-N16R16 website`_.

Hardware
********

SF32LB52-Core-N16R16 provides the following hardware components:
