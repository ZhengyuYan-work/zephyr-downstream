...
void soc_early_init_hook(void)
{
...
#if CONFIG_SF32LB57X_BOOTROM_FLASH_ON_DELAY_MS > 0 || \
	CONFIG_SF32LB57X_BOOTROM_FLASH_OFF_DELAY_MS > 0
	uint32_t val;
	...
	val |= FIELD_PREP(BOOTROM_FLASH_OFF_DELAY_MSK,
			  CONFIG_SF32LB57X_BOOTROM_FLASH_OFF_DELAY_MS) |
	       FIELD_PREP(BOOTROM_FLASH_ON_DELAY_MSK, CONFIG_SF32LB57X_BOOTROM_FLASH_ON_DELAY_MS);
